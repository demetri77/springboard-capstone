---
title: "Banking Capstone - Data Wrangling"
author: "Demetri Lee"
...
```{r}
#bankfull <- read_delim(file = "bank-additional.csv", delim = ";", col_types = "iffccccccciiiicdddddc")
bankfull <- read_delim(file = "bank-additional.csv", delim = ";", col_types = "iffcffffffiiiicdddddc")
```
