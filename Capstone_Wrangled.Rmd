...
# NB! skewed distribution; work w/ the logarithmic scale
...
ggplot(time_to_subscribed, aes(x=subscribed, y=duration_sec)) + 
...
maximum_contact_cnt # sort out how to express this value in the Rmd
```

The bar graph indicates clients will not subscribe if contacted by more than 
the maximum count value, `r maximum_contact_cnt`.
