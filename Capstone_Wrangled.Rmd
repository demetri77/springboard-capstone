...
the dependent variable to something more descriptive than simply, _y_.
```{r}
...
bankfull$edu_lvl[bankfull$edu == "unknown"] <- NA
...
campaign with categorical values "failure", "nonexistent", and "success".
```{r}
...
failed attempts, the large number of nonexistant results makes this features 
useless.**
```{r}
