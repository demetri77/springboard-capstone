...
## Working to predict the success of bank telemarketing
...
attempts, the larger number of NA results makes this variable useless._
```{r}
...
ggplot(bankfull, aes(x=subscribed, y=duration_min)) + geom_boxplot()
...
```{r}
ggplot(bankfull, aes(y=emp_var_rate)) + geom_boxplot()
ggplot(bankfull, aes(y=euribor3m)) + geom_boxplot()
```

5. Can you make a scatterplot?
```{r}
ggplot(bankfull, aes(x=emp_var_rate, y=euribor3m)) + 
  geom_point(aes(colour = factor(subscribed)), alpha = 0.50) + 
